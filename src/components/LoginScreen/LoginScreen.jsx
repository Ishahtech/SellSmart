    ...
    <div className="flex flex-col items-center justify-center h-screen w-screen text-center bg-gray-100">
      <div className="w-4/5 h-[95%] ml-20 bg-white p-8">
        ...
        <div className="relative top-12 flex flex-col items-center">
          <button onClick={() => navigate('/Owner')} className="h-14 mt-2 w-2/3 bg-blue-500 text-white rounded-lg cursor-pointer text-xl flex items-center justify-center">
            <FontAwesomeIcon icon={faUser} className="h-6 w-6 relative right-12" /> Log in as Owner
          </button>
          <div className="mt-4">Or</div>
          <button onClick={() => navigate('/Employee')} className="h-14 mt-2 w-2/3 bg-blue-500 text-white rounded-lg cursor-pointer text-xl flex items-center justify-center">
