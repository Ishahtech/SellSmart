...
import React from "react";
import { Routes, Route, Link } from "react-router-dom";
import InventoryList from "./InventoryList"; // Adjust path based on where InventoryList is located
import AddInventoryItem from "./AddInventoryItem"; // Correct the component name
import UpdateInventoryItem from "./UpdateInventoryItem";
import DeleteInventoryItem from "./DeleteInventoryItem";
